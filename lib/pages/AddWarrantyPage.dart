...
import 'package:ewarrenty/Providers/addWarrentyProvider.dart';
...
class _AddWarrantyPageState extends State<AddWarrantyPage> {
  ...
  Widget build(BuildContext context) {
    // return Provider<AddWarrentyProvider>(
    //     create: (context) => AddWarrentyProvider(),
    //     child: Scaffold(
    //       appBar: AppBar(
    ...
    //             },
    //           ),
    //       body: Consumer<AddWarrentyProvider>(
    ...
    //                       }
    //
    //                       _batteries.forEach((battreyModel) {
    ...
    //                       //todo:save Battery "id" in the form provider
    //                       Market suggestedMarket = suggestion;
    //                       this._marketController.text = AppLocalizations
    //                           .of(context)
    //                           .locale
    //                           .languageCode
    //                           .contains("ar")
                  ...
                  children: [
                      ...
                      builder: (context, state) => TypeAheadFormField(
                        textFieldConfiguration: TextFieldConfiguration(
                          ...
                          decoration: InputDecoration(
                            ...
                            errorText: state is! InitDataBatteryChoosenError
                                ? null
                    ...
                    BlocBuilder<InitDataCubit, InitDataState>(
                      ...
                      builder:(context,state)=> TextFormField(
                        ...
                        keyboardType: TextInputType.emailAddress,
                        decoration: InputDecoration(
                          errorText: state is! InitDataEmailError?null:
                          "please enter email",
                          labelText:
                        ...
                        onTap: (){
                          BlocProvider.of(context).emit(InitDataEmailReset());
                        },
                        onChanged: (value) {
                        ...
                        if (state is InitDataBatteryChosen)
                          return FlatButton(
                            child: ImagePreview(
                              ...
                              CachedNetworkImage(
                                imageUrl:
                                    "$baseUrl/${state.battery.frontImage}",
                                fit: BoxFit.cover,
                              ),
                            ),
                            onPressed: () async {
